...
async def fikrfree(phone, client, out):
    ...
    try:
        ...
        out.append({"name": name,"domain":domain,"frequent_rate_limit":frequent_rate_limit,  "rateLimit": False, "sent": False, "error": True, "reason": str(exc) or "token request failed"})
        return None
